...
def _calc_semantic_segmentation_confusion(pred_labels, gt_labels, num_classes):
    batch_confusion_matrix = jax.vmap(confusion_matrix, in_axes=[0, 0, None])
    batch_cm = batch_confusion_matrix(gt_labels, pred_labels, num_classes)
...
def eval_semantic_segmentation(pred_labels, gt_labels, num_classes):
